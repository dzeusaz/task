 ...
 */
public class GetDecathlonCompetitionDataTest {
    ...
    public void testGetData() throws Exception {
        ...
        for(DecathlonData result: data.getData("src/com/competition/jUnit/testData.txt")){
            ...
            assertEquals((Double) 14.52, result.getShotPut());
            //assertEquals((Double) 201.0, result.getHighJump());
            assertEquals((Double) 45.00, result.getRun_400_metres());
            assertEquals((Double) 13.69, result.getRun_110_metres());
            assertEquals((Double) 43.34, result.getDiscusThrow());
            assertEquals((Double) 520.0, result.getPoleVault());
